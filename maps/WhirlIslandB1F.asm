...
WhirlIslandB1FHiddenUltraBall:
	hiddenitem RARE_CANDY, EVENT_WHIRL_ISLAND_B1F_HIDDEN_ULTRA_BALL
...
WhirlIslandB1F_MapEvents:
	...
	object_event 33,  2, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, WhirlIslandB1FFieldMon6Script, EVENT_FIELD_MON_6
	object_event 20, 14, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, WhirlIslandB1FFieldMon7Script, EVENT_FIELD_MON_7
