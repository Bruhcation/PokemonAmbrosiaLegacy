...
Route41FieldMon4Script:
	trainer KINGDRA, FIELD_MON, EVENT_FIELD_MON_4, Route41PokemonAttacksText, 56, 0, .script
.script
...
Route41_MapEvents:
	...
	object_event 40,  4, SPRITE_SURF, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route41FieldMon1Script, EVENT_FIELD_MON_1
	object_event  7,  2, SPRITE_SURF, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route41FieldMon2Script, EVENT_FIELD_MON_2
	object_event 47,  26, SPRITE_SURF, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route41FieldMon3Script, EVENT_FIELD_MON_3
	object_event 22,  27, SPRITE_SURF, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route41FieldMon4Script, EVENT_FIELD_MON_4
