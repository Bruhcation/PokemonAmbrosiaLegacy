...
; entries correspond to constants/move_constants.asm
	...
	move MEGA_PUNCH,   EFFECT_NORMAL_HIT,         90, NORMAL,        PHYSICAL,  95, 20,   0
	...
	move CUT,          EFFECT_NORMAL_HIT,         60, BUG,           PHYSICAL,  95, 30,   0
	...
	move MEGA_KICK,    EFFECT_NORMAL_HIT,        120, NORMAL,        PHYSICAL,  85, 10,   0
	move MOON_BLAST,   EFFECT_SP_ATK_DOWN_HIT,    95, FAIRY,         SPECIAL,  100, 15,  30
	move BIG_RECOVER,  EFFECT_HEAL,                0, NORMAL,        STATUS,   100,  5,   0
	...
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          18, NORMAL,        PHYSICAL, 100, 20,   0
	...
	move WRAP,         EFFECT_TRAP_TARGET,        25, NORMAL,        PHYSICAL, 100, 20,   0
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         90, NORMAL,        PHYSICAL, 100, 20,   0
	...
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,        STATUS,    65, 20,   0
	...
	move BLIZZARD,     EFFECT_FREEZE_HIT,        120, ICE,           SPECIAL,   75, 10,  10
	...
	move AURORA_BEAM,  EFFECT_ATTACK_DOWN_HIT,    70, ICE,           SPECIAL,  100, 20,  10
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        140, NORMAL,        SPECIAL,  100, 10,   0
	...
	move STRENGTH,     EFFECT_NORMAL_HIT,         90, NORMAL,        PHYSICAL, 100, 15,   0
	...
	move PETAL_DANCE,  EFFECT_RAMPAGE,           120, GRASS,         SPECIAL,  100, 20,   0
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        25, FIRE,          SPECIAL,  100, 15,   0
	...
	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL,        STATUS,    95, 40,   0
	...
	move ZEN_HEADBUTT, EFFECT_FLINCH_HIT,         85, PSYCHIC_TYPE,  PHYSICAL, 100, 20,  30
	...
	move POISON_JAB,   EFFECT_POISON_HIT,         85, POISON,        PHYSICAL, 100, 20,  30
	...
	move POISON_GAS,   EFFECT_POISON,              0, POISON,        STATUS,    95, 40,   0
	move ROOST,        EFFECT_HEAL,                0, FLYING,        STATUS,   100,  5,   0
	...
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          18, NORMAL,        PHYSICAL, 100, 15,   0
	...
	move BULLET_PUNCH, EFFECT_PRIORITY_HIT,       40, STEEL,         PHYSICAL, 100, 15,   0
	move X_SCISSOR,    EFFECT_NORMAL_HIT,         80, BUG,           PHYSICAL, 100, 15,   0
	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         80, NORMAL,        SPECIAL,  100, 15,  20
	move FINAL_FANG,   EFFECT_FLINCH_HIT,        120, NORMAL,        PHYSICAL, 100, 15,  30
	...
	move FLAME_WHEEL,  EFFECT_NORMAL_HIT,        65, FIRE,          PHYSICAL, 100,  25,  10
	...
	move KINGS_SHIELD, EFFECT_KINGS_SHIELD,        0, STEEL,         STATUS,   100, 15,   0
	move AEROBLAST,    EFFECT_NORMAL_HIT,        100, FLYING,        SPECIAL,  100, 10,   0
	move SHADOW_FIST,  EFFECT_NORMAL_HIT,         85, GHOST,         PHYSICAL, 100, 15,   0
	...
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      100, ELECTRIC,      SPECIAL,   70, 10, 100
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       100, FIGHTING,      PHYSICAL,  70, 10, 100
	...
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      60, STEEL,         PHYSICAL,  95, 35,  10
	...
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        35, WATER,         SPECIAL,  100, 15,   0
